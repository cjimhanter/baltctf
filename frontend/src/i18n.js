...
const messages = {
  en: {
    ...
    admin: {
      ...
      checkedStatuses: "Checked",
      checkerMatrixSize: "{teams} teams x {services} services",
      checkerCoverage: "{checked} of {expected} recorded",
      pendingChecks: "Not reported by the latest tick",
      checkerIssues: "Issues",
      issueStatuses: "Mumble, corrupt, down, or unknown",
      latestCheckerIssues: "Latest checker issues",
      noCheckerIssues: "No checker issues for the active round.",
      checkerIssueTarget: "{team} / {service}",
  ...
  ru: {
    ...
    admin: {
      ...
      expectedChecks: "Ожидаемые проверки",
      checkedStatuses: "Получено",
      checkerMatrixSize: "{teams} команд x {services} сервисов",
      checkerCoverage: "{checked} из {expected} записано",
      pendingChecks: "Не пришли в последнем tick",
      checkerIssues: "Проблемы",
      issueStatuses: "Mumble, corrupt, down или unknown",
      latestCheckerIssues: "Последние проблемы checker",
      noCheckerIssues: "В активном раунде нет проблем checker.",
      checkerIssueTarget: "{team} / {service}",
